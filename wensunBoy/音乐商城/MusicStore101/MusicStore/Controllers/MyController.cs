    ...
    public class MyController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var myVM = new MyViewModel()
            {
                ...
                MobliNumber = person.MobileNumber,
        ...
        public ActionResult Index(MyViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.Avarda != null)
                {
                    ...
                    var imagePath = Path.Combine(Server.MapPath(uploadDir), person.ID + "." + fileLastName);//将网站虚拟路径转化成真实的物理路径
                    model.Avarda.SaveAs(imagePath);
                    oldAvarda = "~/Upload/Avarda/" + person.ID + "." + fileLastName;
                }
                //保存个人信息

                person.MobileNumber = model.MobliNumber;
