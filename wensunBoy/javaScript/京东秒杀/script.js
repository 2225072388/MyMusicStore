function updateTime() {
    //秒杀结束的时间
    var endtime = new Date('2018/10/25,11:53:00');
    //取当前时间
...
if(leftSecond<=0){
    ...
    document.getElementById("end-box").style.background="url(image/flash_end.png) no-repeat";
    ducument.getElementById("end-box").innerHTML="秒杀已结束";
